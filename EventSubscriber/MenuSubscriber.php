<?php
namespace KimaiPlugin\NeontribeCvsImportBundle\EventSubscriber;
...
class MenuSubscriber implements EventSubscriberInterface {
  ...
  public function onMenuConfigure(ConfigureMainMenuEvent $event) {
    ...
    if ($auth->isGranted('ROLE_SUPER_ADMIN') || $auth->isGranted('edit_custom_css')) {
      $menu->addChild(new MenuItemModel('neontribe_cvs_import_admin', 'Import CSV', 'neontribe_cvs_import_admin', [], 'fa fa-upload'));
    }
  }
}
